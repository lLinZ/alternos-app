                    ...
                    <Form onSubmit={handleSubmit}>
                        <Grid container spacing={1}>
                            ...
                            <Grid item xs={12} sm={6}>
                                <TextField name="name" color="secondary" onChange={handleChange} sx={{ background: "#FFF", borderRadius: 5 }} InputProps={{ sx: { borderRadius: 5 } }} label="Nombre" fullWidth value={values.name} />
                            </Grid>
                            <Grid item xs={12} sm={6}>
                                <TextField name="phone" color="secondary" onChange={handleChange} sx={{ background: "#FFF", borderRadius: 5 }} InputProps={{ sx: { borderRadius: 5 } }} label="Teléfono" fullWidth value={values.phone} />
                            </Grid>
                            <Grid item xs={12}>
                                <TextField name="username" color="secondary" onChange={handleChange} sx={{ background: "#FFF", borderRadius: 5 }} InputProps={{ sx: { borderRadius: 5 } }} label="Username" fullWidth value={values.username} />
                            </Grid>
                            <Grid item xs={12} sm={6}>
                                <TextField name="password" color="secondary" onChange={handleChange} sx={{ background: "#FFF", borderRadius: 5 }} InputProps={{ sx: { borderRadius: 5 } }} label="Contraseña" fullWidth value={values.password} />
                            </Grid>
                            <Grid item xs={12} sm={6}>
                                <TextField name="confirmPassword" color="secondary" onChange={handleChange} sx={{ background: "#FFF", borderRadius: 5 }} InputProps={{ sx: { borderRadius: 5 } }} label="Confirmar contraseña" fullWidth value={values.confirmPassword} />
                            </Grid>
                            <Grid item xs={12}>
