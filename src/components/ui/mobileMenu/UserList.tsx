...
import { pages, traficoPages, ventasPages } from '../pages';
...
export const UserList: FC<Props> = ({ user }) => {
    ...
    return (
        <>
            {
                user?.function_name === 'Tráfico' && traficoPages.map((page: Pages, i: number) => (String(currentPath.pathname) !== String(page.path) ?
            ...
            {
                user?.role_name === 'Comercial' && ventasPages.map((page: Pages, i: number) => (String(currentPath.pathname) !== String(page.path) ?
            ...
            {
                user?.function_name !== 'Tráfico' && user?.role_name !== 'Comercial' && pages.map((page: Pages, i: number) => (String(currentPath.pathname) !== String(page.path) ?
