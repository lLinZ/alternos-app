    ...
    return (
        <>
            {widgets && widgets.length > 0
                ...
                : (
                    <Box sx={{ boxShadow: '0 8px 32px 0 rgba(100,100,100,0.1)', display: "flex", flexFlow: "column wrap", justifyContent: "center", alignItems: "center", background: "#FFF", borderRadius: 5, p: 5, minWidth: { xs: "100%", sm: 450 }, maxWidth: { xs: "100%", sm: 450 }, minHeight: 250, maxHeight: 250, m: 1 }}>
