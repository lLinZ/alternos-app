...
export const WidgetInformativo: FC<Props> = () => {
    return (
        <Box sx={{ width: { xs: "100%", sm: 250 }, height: "100%", minHeight: 250, maxHeight: 250, background: "#FFF", borderRadius: 5, mb: 1, overflow: "hidden", pb: 2 }}>
            <Box sx={{ display: "flex", flexFlow: "column wrap", justifyContent: "center", alignItems: "center", width: "100%", p: 1 }}>
                <img src="./dashboard-image.jpg" style={{ minWidth: 80, maxWidth: 150, width: "auto" }} />
