...
export const WidgetInformativo: FC<Props> = () => {
    return (
        <Box sx={{ boxShadow: '0 8px 32px 0 rgba(100,100,100,0.1)', minWidth: { xs: "100%", sm: 450 }, maxWidth: { xs: "100%", sm: 450 }, height: "100%", minHeight: 250, maxHeight: 250, background: "#FFF", borderRadius: 5, m: 1, overflow: "hidden", pb: 2 }}>
