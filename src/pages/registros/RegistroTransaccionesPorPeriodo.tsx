...
export const RegistroTransaccionesPorPeriodoPage: FC = () => {
    ...
    const getTransacciones = async (from = null as string | null, to = null as string | null) => {
        setIsLoading(true);
        let url = '';
        url = from && to ? `${baseUrl}/reportesdepagoperiodo?desde=${from}&hasta=${to}` : url !== '' ? url : '';
        url = !from && to ? `${baseUrl}/reportesdepagoperiodo?hasta=${to}` : url !== '' ? url : '';
        url = from && !to ? `${baseUrl}/reportesdepagoperiodo?desde=${from}` : url !== '' ? url : '';
        url = !from && !to ? `${baseUrl}/reportesdepagoperiodo` : url !== '' ? url : '';
        ...
        <Layout user={userLogged}>
            <LocalizationProvider locale="es" dateAdapter={AdapterMoment}>
                ...
                <Box sx={styles.mainContainer}>
                    <Typography variant="overline" fontWeight={"bold"}>Reporte de Pagos del periodo</Typography>
